pub fn main() !void {
    ...
    try server.router("/p**", .{
        ...
        .{ "/dist",         r.module(Injector, part.add.validate_dist_pn) },
        .{ "/dist:*",       r.module(Injector, part.add.validate_dist_pn) },
        .{ "/pn",           r.module(Injector, part.add.validate_dist_pn) },
        .{ "/pn:*",         r.module(Injector, part.add.validate_dist_pn) },
        ...
        .{ ":*/dist",       r.module(Injector, part.edit.dist_pn) },
        .{ ":*/dist:*",     r.module(Injector, part.edit.dist_pn) },
        .{ ":*/pn",         r.module(Injector, part.edit.dist_pn) },
        .{ ":*/pn:*",       r.module(Injector, part.edit.dist_pn) },
